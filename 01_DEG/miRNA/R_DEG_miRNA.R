setwd("/Users/liuzhe/Desktop/cityu/ceRNA_network/02_ceRNA-Projects/01_DEG/miRNA/")
library(SummarizedExperiment)

counts_STAD<-read.csv("/Users/liuzhe/Desktop/cityu/ceRNA_network/02_ceRNA-Projects/TCGA_data/miRNA/counts_STAD_miRNA.csv")
